...
exports.SpecialtyMedicalHistoryResponseDto = exports.MedicalHistoryBaseResponseDto = void 0;
class MedicalHistoryBaseResponseDto {
    id;
    bloodType;
    personalHistory;
    chronicDiseases;
    ...
    createdAt;
    updatedAt;
    constructor(medicalHistoryBase) {
...
exports.MedicalHistoryBaseResponseDto = MedicalHistoryBaseResponseDto;
class SpecialtyMedicalHistoryResponseDto {
    id;
    specialtyType;
    chiefComplaint;
    currentIllness;
    ...
    createdAt;
    updatedAt;
    constructor(specialtyMedicalHistory) {
...
exports.SpecialtyMedicalHistoryResponseDto = SpecialtyMedicalHistoryResponseDto;
//# sourceMappingURL=medical-history-response.dto.js.map